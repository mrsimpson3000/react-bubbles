...
- [ ] Explain what a token is used for.
      ...
      A token is used for access permission. It allows a user to log into a web page and access 'secure' areas of the site.

- [ ] What steps can you take in your web apps to keep your data secure?

      We can use React Router with secure routes as well as the previously mentioned url tokens.

- [ ] Describe how web servers work.

       Web servers are hosted in a location, often called a server farm, and contain all the info pertaining to a website. A site is considered hosted by the server. If you have a fast enough internet connection you can host it in your home but with the low cost of hosting a website today I don't know why you would.

* [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

      CRUD is the standardized use of different HTTP action verbs (I hate this term. Action verbs. Give me a break.) I read that if you're using a resting api be sure to use nouns instead of verbs. Yes dear. The 'words' we used were GET, POST, PUT and DELETE. I have no idea how many there are. CRUD stands for create, read, update and delete, fyi.
